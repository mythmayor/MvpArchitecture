...
import com.mythmayor.mvparchitecture.MyApplication;
import com.mythmayor.mvparchitecture.itype.OnGlideLoadListener;
...
public class GlideUtil {
    ...
    public static void destroy() {
        ...
        GlideCacheUtil.getInstance().clearImageAllCache(MyApplication.getContext());
    }
}
